...
train_file=${TRAIN_FILE:-/data/xgq/data/geo3k_multiturn_w_tool/train.parquet}
val_file=${VAL_FILE:-/data/xgq/data/geo3k_multiturn_w_tool/test.parquet}
