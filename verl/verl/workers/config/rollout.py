...
class RolloutConfig(BaseConfig):
    ...
    # Optional CSV populated from vLLM's post-profile memory accounting.
    engine_memory_log: Optional[str] = None
    # Optional per-request vLLM timing CSV; excludes agent and tool execution.
    request_metrics_log: Optional[str] = None
